...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_newvaultshared_3199;
            let db_auth = result.data.DB_AUTH_newvaultshared_3199;
            let db_coll = result.data.DB_COLL_newvaultshared_3199;
